...
class BTPeer:
    ...
    #--------------------------------------------------------------------------
        ...
        list of peers. The functions addpeerat, get_peerat, and removepeerat
        should not be used concurrently with addpeer, get_peer, and/or 
        removepeer. 
    ...
    #--------------------------------------------------------------------------
        ...
        response = Response(msgreply[0][0],msgreply[0][1])
